...
var mouseDown = function (e) {
  ...
  e.preventDefault();
  console.log("mouseDown", " old_x : ", old_x, " old_y : ", old_y);
  return false;
};
...
var mouseMove = function (e) {
  ...
  (dX = ((e.pageX - old_x) * 2 * Math.PI) / canvas.width), (dY = ((e.pageY - old_y) * 2 * Math.PI) / canvas.height);
  THETA += dX;
  PHI += dY;
  (old_x = e.pageX), (old_y = e.pageY);
  console.log("mouseMove", " old_x : ", old_x, " old_y : ", old_y, " Theta : ", THETA, " Phi : ", PHI);
